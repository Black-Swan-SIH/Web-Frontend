  ...
  <div className="row" style={{}}>
    ...
    <div className="col-md-8" >
      <div className="card-body mt-3 pt-2">
        <h5 className="card-title" style={{fontSize:"20px",fontWeight:"600", color: "#202020"}}>{title}</h5>
        <p className="card-text mt-2" style={{color: "#2B2B2B", fontSize: "13px", fontWeight: "500"}}>Application : 101</p>
        <p className="card-text text-muted mt-2" style={{fontSize:"10px", color: "#3D3D3D", fontWeight: "500"}}><p className="text-body-secondary"></p>Last updated 3 mins ago</p>
      </div>
    </div>
  </div>
</div>
