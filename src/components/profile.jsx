  ...
  return (
    <>
      ...
      <div className="container mt-5 pt-5" style={{marginLeft:"60px"}}>
        ...
        <div className="mb-4 col-md-8 mt-5 pt-5 mb-5 pb-5" style={{marginTop:"30px"}}>
       <div className="ml-5 pl-5" style={{marginTop:"47px",marginLeft:"30px"}}>
       <button className="mt-5 mb-5"  style={{border:"1px solid black",backgroundColor:"white", marginTop:"15px", width:"70px",height:"20px", borderRadius:"20px",color:"grey", borderColor:"grey"}}>verified</button>
          <Details userId={userId} ></Details>

        <button className="mt-5"  style={{color:"white",backgroundColor:"black", marginTop:"15px", width:"120px",height:"30px", borderRadius:"10px"}}>Edit Profile</button>
       </div>
      ...
      <div className="container row g-4 ml-5 pl-5">
        ...
        <div className="col-md-5 pl-5 pr-5 pt-5" style={{marginLeft:"0px"}}>
          <div className="px-5 mx-5">
            ...
            <p className="text-muted">Key Skill   &nbsp;. <span style={{color:"black"}}>&nbsp;&nbsp;Node.js Developer</span></p>
            <ul className="mr-5 pr-5">
              <li style={{marginBottom:"15px", marginTop:"15px"}}><TopSkills value={80} skill="Docker"/></li>
              <li style={{marginBottom:"15px"}}><TopSkills value={70} skill="Node.js"/></li>
              <li style={{marginBottom:"15px"}}><TopSkills value={50} skill="TypeScript"/></li>
              <li style={{marginBottom:"15px"}}><TopSkills value={90} skill="Next.js"/></li>
              <li style={{marginBottom:"15px"}}><TopSkills value={100} skill="Flutter"/></li>
      
            </ul>
       
          </div>
          <div className="px-5 mx-5 mt-3">
            <h1 style={{fontSize:"30px",fontWeight:"600", marginBottom:"10px",marginTop:"10px"}}>Reviews</h1>
            <p className="text-muted">4.8 / 5   &nbsp;<span  style={{color:"black"}}><i class="fa-solid fa-star"></i></span></p>

            <ul className="pt-5">
              <li><p>Jordan k.</p>
              <p className="text-muted" style={{maxWidth:"300px"}}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illum  </p>
              </li>
        ...
        <div className="col-md-4">
          <div className="" style={{marginRight:"10px", marginLeft:"-50px"}}>
            <h4 style={{fontSize:"30px",fontWeight:"600",marginTop:"5px",marginBottom:"15px"}}>Scheduled Interviews</h4>
            <ul>
